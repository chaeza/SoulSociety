...
public class DamageDecrpease : MonoBehaviourPun, ItemMethod//아이템 인터페이스 상속
{
    [SerializeField]
    int itemNum = 0;
    ...
    public void ItemSkill()//이 아이템이 가지고 있는 아이템 스킬 사용
    {
        ...
        GameObject a = PhotonNetwork.Instantiate("damageDecrpease", transform.position, Quaternion.identity);//이펙트를 포톤 인스턴스를 합니다.
        ...
        gameObject.GetPhotonView().RPC("SetDamageDecrpease", RpcTarget.All, 30f,3f);
