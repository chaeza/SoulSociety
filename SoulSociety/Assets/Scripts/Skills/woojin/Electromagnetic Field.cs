...
public class ElectromagneticField : MonoBehaviourPun
{
    int skillRange = 10;
    ...
    public void SkillClick(Vector3 Pos)
    {
        if (skillClick == true)
        {
            ...
            {
                GameObject a = PhotonNetwork.Instantiate("using Ph;", transform.position, Quaternion.identity);//이펙트를 포톤 인스턴스를 합니다.
