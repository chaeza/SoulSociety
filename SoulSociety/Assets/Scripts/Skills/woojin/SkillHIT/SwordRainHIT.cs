...
public class SwordRainHIT : MonoBehaviourPun
{
    int Attacker;//공격자 선언
    float timer;
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {
            other.gameObject.GetPhotonView().RPC("RPC_hit", RpcTarget.All, 5f, Attacker, state.Stun, 0.2f);//맞은적에게 데미지를 주고 누가 때린지 보냄.
